...
import { LayoutDashboard, ListTodo, FileCodeCorner, Users, Clock, TrendingUp } from 'lucide-react';
                        ...
                        {analytics.recentActivity.map((activity, index) => (
                            ...
                            >
                                ...
                                <div className="text-right">
                                    ...
                                    <div className={`text-sm ${activity.status === 'graded' ? 'text-green-400' : 'text-yellow-400'
                                        }`}>
                                        {activity.status}
                                    </div>
                                </div>
