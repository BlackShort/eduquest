...
export const AssessmentProvider = ({
    ...
    const [currentQuestionId, setCurrentQuestionId] = useState(INITIAL_QUESTIONS[0].id);
    ...
    useEffect(() => { handleSubmitRef.current = handleSubmitAssessment; }, [handleSubmitAssessment]);
    ...
    const decrementTimeRemaining = useCallback(() => {
        setTimeRemaining((prev) => {
            ...
            if (next === 0 && stageRef.current === "exam" && !isSubmittedRef.current) {
